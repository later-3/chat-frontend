...
const LEGACY_CACHE_PREFIX = "pi-web";
...
const PRECACHE_URLS = [
  ...
  "/lifeos-astronaut-192x192.png",
  "/lifeos-astronaut-512x512.png",
  "/lifeos-astronaut-apple-touch-icon.png",
];
...
self.addEventListener("push", (event) => {
  event.waitUntil((async () => {
    ...
    const title = typeof payload.title === "string" ? payload.title : "Chat 任务已完成";
    const options = {
      ...
      tag: typeof payload.tag === "string" ? payload.tag : "chat-complete",
