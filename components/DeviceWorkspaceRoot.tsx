...
export function DeviceWorkspaceRoot() {
  const [initialNavigation] = useState(() => getInitialNavigation(new URLSearchParams(window.location.search)));
  ...
  const statusCard = (
    <div className={styles.statusCard} role="status" aria-live="polite">
      ...
      <span className={styles.statusText}>
        <strong>{t("devices.connecting", { name: workspace.transition.targetDeviceName ?? "Chat" })}</strong>
