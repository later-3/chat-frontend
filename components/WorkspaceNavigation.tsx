import { IconUsers, IconFolders, IconPhoto, IconSettings, IconMessageCircle } from "@tabler/icons-react";
import { useI18n } from "@/hooks/useI18n";

export type WorkspaceSection = "coworkers" | "projects" | "moments" | "settings";
