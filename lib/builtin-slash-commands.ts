...
/** Only registered commands are UI actions; a leading slash also occurs in file paths. */
export function getBuiltinSlashCommand(message: string): BuiltinSlashCommand | undefined {
