...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "memory.emptyHint": "Add an explicit durable fact or change the current filters.",
    "memory.score": "score",
    ...
    "memory.rebuildConfirm": "Rebuild the complete Mem0 index from the Chat catalog?",
